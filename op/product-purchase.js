...
let updateStatment=[]
    ...
    updateStatment=`UPDATE Product SET remaining_amount = remaining_amount+${data[data.length-1].Purchased_qty}, selling_price=${data[data.length-1].Selling_price} WHERE product_id =${data[data.length-1].product_code};`
...
module.exports={registerPurchase,getPurchaseOrderNumber,closeOrderNumber,getVendorDetail}